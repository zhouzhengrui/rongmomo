...
var areaExpress, areaCont, areaList = $("#areaList"),
...
function intProvince() {
    ...
    $("#areaContent").scrollTop(0);
    $("#areaBack").removeAttr("onClick").hide();
}
intProvince();
...
function selectP(p) {
    ...
    $("#areaBack").attr("onClick", "intProvince();").show();
}
...
function selectC(p, c) {
    ...
    if (sCity != "省直辖县级行政单位") {
        if (sCity == "东莞市" || sCity == "中山市" || sCity == "儋州市" || sCity == "嘉峪关市") {
            areaExpress += sCity;
            $("#areaExpress p").html(areaExpress);
            clockArea();
    ...
    $("#areaBack").attr("onClick", "selectP(" + p + ");");
}
